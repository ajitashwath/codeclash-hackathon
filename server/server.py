...
def convert_to_slide_elements(ai_response):
    """Convert AI response to frontend slide elements"""
    elements = []
    y_position = 80
...
def generate_slide():
    ...
    try:
        ...
        logger.info(f"Generating slide for: {prompt}")
        ...
        slide = {
            ...
            "elements": convert_to_slide_elements(ai_response),
